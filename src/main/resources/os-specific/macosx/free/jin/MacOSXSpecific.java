...
/**
 * This class does various Mac OS X specific things for Jin. It is only compiled and used when
 * running under OS X. Using it involves simply loading it via <code>Class.forName</code>
 */
public class MacOSXSpecific {
  ...
  /** Registers an <code>ApplicationListener</code> with the <code>Application</code>. */
        ...
        .addApplicationListener(
            new ApplicationAdapter() {
              ...
              public void handleQuit(ApplicationEvent evt) {
                ...
                if (jin != null) jin.quit(false);
              }

              public void handleAbout(ApplicationEvent evt) {
                evt.setHandled(true);
                Jin jin = Jin.getInstance();
                if (jin != null) jin.showAboutDialog();
              }
            });
  }
}
