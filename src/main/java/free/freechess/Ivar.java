...
public class Ivar {
  ...
  private static final Hashtable INDEX_TO_IVAR = new Hashtable();

  /** Maps ivar names to ivars. */
  private static final Hashtable NAME_TO_IVAR = new Hashtable();

  /** The compressmove ivar. Issue "help iv_compressmove" on FICS for more information. */
  ...
  /** The seekremove ivar. Issue "help iv_seekremove" on FICS for more information. */
  ...
  /** The nohighlight ivar. Probably disables some kind of special server signals. */
  public static final Ivar NOHIGHLIGHT = new Ivar("nohighlight", 13);

  /**
   * The vt_highlight ivar. Probably enables some kind of special server signals designed to
   * highlight things on terminals.
   */
  ...
  /**
   * The pin ivar. Probably enables and disables notifications about players arriving and departing.
   */
  public static final Ivar PIN = new Ivar("pin", 16);

  /**
   * The ms ivar. Asks the server to send current time in style12 in milliseconds instead of
   * seconds.
   */
  ...
  /** The showownseek ivar. Asks the server to send the user's own seek as part of seekinfo. */
  public static final Ivar SHOWOWNSEEK = new Ivar("showownseek", 22);

  /** The premove ivar. Interfaces can set this (useless) variable on if they support premove. */
  public static final Ivar PREMOVE = new Ivar("premove", 23);

  /** The smartmove ivar. No idea what it does, but presumably the same as the premove ivar. */
  ...
  /**
   * Returns the index of the ivar when its value is specified on the login line. Indices start at
   * 0.
   */
  public int getIndex() {
    return index;
