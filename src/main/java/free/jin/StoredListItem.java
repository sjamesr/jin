...
public class StoredListItem extends GameListItem {
  ...
  /**
   * Creates a new StoredListItem with the given GameListItem properties, whether the opponent is
   * present, the reason of the adjournmen and the player for whom the command was issued.
   */
  public StoredListItem(
      int index,
      String gameID,
      String dateString,
      String timeString,
