...
public class FriendsEvent extends JinEvent {
  ...
  /**
   * The friend's state - an <code>OR</code> combination of the relevant friend state masks in
   * <code>FriendsConnection</code>.
   */
  private final int friendState;

  /**
   * Creates a new <code>FriendsEvent</code> with the specified source <code>FriendsConnection
   * </code> event id, friend and his state.
   */
  public FriendsEvent(
      FriendsConnection source, String clientTag, int id, ServerUser friend, int friendState) {
    ...
    if (friend == null) throw new IllegalArgumentException("friend may not be null");
  ...
  /**
   * Returns the friend's state - an <code>OR</code> combination of the relevant <code>
   * *_FRIEND_STATE_MASK</code> masks in <code>FriendsConnection</code>. This is only relevant if
