...
/**
 * The extension of ListenerManager allowing registering and unregistering FriendsListeners.
 */
public interface FriendsListenerManager extends ListenerManager {
  ...
  /**
   * Removes a FriendsListener from the list of listeners receiving FriendsEvents.
   */
