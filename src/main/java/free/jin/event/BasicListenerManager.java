...
public class BasicListenerManager
  ...
  /**
   * Notifies all interested <code>Connection</code> listeners that an attempt to connect is being
   * made.
   */
  ...
  /**
   * Notifies all interested <code>Connection</code> listeners that a connection to the server has
   * been established.
   */
  ...
  /**
   * Notifies all interested <code>Connection</code> listeners that the connection to the server was
   * lost.
   */
  ...
  /**
   * Adds the given <code>PlainTextListener</code> to receive notification when otherwise
  ...
  /**
   * Removes the given <code>PlainTextListener</code> from the list of listeners receiving
   * notification when otherwise unidentified text arrives from the server.
   */
  @Override
  ...
  /**
   * Adds the specified <code>ChatListener</code> to receive notification when chat related messages
  ...
  /**
   * Removes the specified <code>ChatListener</code> from the list of <code>ChatListeners</code>
   * receiving notification when chat related messages arrive from the server.
   */
  @Override
   ...
   * notifications of <code>GameEvent</code>s.
   */
  @Override
  ...
  public void fireGameEvent(GameEvent evt) {
    ...
    for (int i = 0; i < listeners.length; i += 2) {
      if (listeners[i] == GameListener.class) {
        ...
        try {
          if (evt instanceof GameStartEvent) listener.gameStarted((GameStartEvent) evt);
          else if (evt instanceof GameEndEvent) listener.gameEnded((GameEndEvent) evt);
          else if (evt instanceof MoveMadeEvent) listener.moveMade((MoveMadeEvent) evt);
          else if (evt instanceof PositionChangedEvent)
            listener.positionChanged((PositionChangedEvent) evt);
          else if (evt instanceof TakebackEvent) listener.takebackOccurred((TakebackEvent) evt);
          ...
          else if (evt instanceof BoardFlipEvent) listener.boardFlipped((BoardFlipEvent) evt);
          else if (evt instanceof OfferEvent) listener.offerUpdated((OfferEvent) evt);
          else throw new IllegalArgumentException("Unknown GameEvent type: " + evt.getClass());
        } catch (RuntimeException e) {
          e.printStackTrace();
        }
      }
  ...
  /**
   * Adds the specified <code>SeekListener</code> to the list of listeners receiving notification of
   * <code>SeekEvent</code>s.
   */
  @Override
  public void addSeekListener(SeekListener listener) {
    if (!(source instanceof SeekConnection))
      throw new UnsupportedOperationException(
          "The source Connection is not an instance of SeekConnection");

    listenerList.add(SeekListener.class, listener);
  }

  /**
   * Removes the specified <code>SeekListener</code> from the list of listeners receiving
   * notification of <code>SeekEvent</code>s.
   */
  @Override
  ...
  public void addGameListListener(GameListListener listener) {
    if (!(source instanceof GameListConnection))
      throw new UnsupportedOperationException(
          "The source Connection is not an instance of GameListConnection");

    listenerList.add(GameListListener.class, listener);
  }

  /**
   * Removes the specified <code>GameListListener</code> from the list of listeners receiving
   * notifications of <code>GameListEvent</code>s.
   */
  @Override
  ...
  /**
   * Fires the specified <code>GameListEvent</code> to all interested <code>GameListListener</code>
   * s.
   */
  ...
  /**
   * Adds the specified <code>FriendsListener</code> to the list of listeners receiving
   * notifications of <code>FriendsEvent</code>s.
   */
  @Override
  public void addFriendsListener(FriendsListener listener) {
    if (!(source instanceof FriendsConnection))
      throw new UnsupportedOperationException(
          "The source Connection is not an instance of FriendsConnection");

    listenerList.add(FriendsListener.class, listener);
  }

  /**
   * Removes the specified <code>FriendsListener</code> from the list of listeners receiving
   * notifications of <code>FriendsEvent</code>s.
   */
  @Override
  ...
  public void addMatchOfferListener(MatchOfferListener listener) {
    if (!(source instanceof MatchOfferConnection))
      throw new UnsupportedOperationException(
          "The source connection is not an instance of MatchOfferConnection");

    listenerList.add(MatchOfferListener.class, listener);
  }

  /**
   * Removes the specified <code>MatchOfferListener</code> from the list of listeners receiving
   * notifications of <code>MatchOfferEvent</code>s.
   */
  @Override
