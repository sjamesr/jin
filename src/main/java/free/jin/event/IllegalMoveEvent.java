...
/**
 * The event fired when the user tried to make a move and the server rejected it.
 */
public class IllegalMoveEvent extends GameEvent {
  ...
  /**
   * The reason code for an attempt to make a move when it isn't the user's turn.
   */
  ...
  /**
   * Creates a new IllegalMoveEvent with the given source Connection, Game and the attempted illegal
   * move.
   */
  ...
  /**
   * Returns the reason code for the rejection - one of the constants defined in this class.
   */
