...
/**
 * The event fired by a <code>MatchOfferConnection</code> when a match offer is made or withdrawn.
 */
public class MatchOfferEvent extends JinEvent {
  ...
  public MatchOfferEvent(
    ...
    if (matchOffer == null) throw new IllegalArgumentException("matchOffer may not be null");
