...
public class UserMatchOffer extends Struct {
  ...
  public UserMatchOffer(
      ...
      WildVariant variant,
      Player color) {
    if (opponent == null) throw new IllegalArgumentException("opponent may not be null");
  ...
  /**
   * Returns the color with which the user wishes to play, or <code>null</code> for automatic color
   * assignment.
   */
