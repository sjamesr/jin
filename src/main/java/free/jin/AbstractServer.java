...
public abstract class AbstractServer implements Server {
  ...
  /**
   * Returns the hostname of the default host for this server. The property name is
   * <code>defaultHost</code>.
   */
  @Override
  ...
  /**
   * Returns the list of hostnames for the hosts of this server. The property name is
   * <code>hosts</code> and the property value is a space delimited list of hostnames.
   */
  @Override
  ...
  /**
   * Returns a list of the ports on which the server is listening. The property name is
   * <code>ports</code> and the property value is a space delimited list of valid port values.
   */
  @Override
  public int[] getPorts() {
