...
public class PluginUIEvent extends EventObject {
  ...
  /**
   * Creates a new <code>PluginUIEvent</code> with the specified source <code>PluginUIContainer
   * </code> and event id.
   */
  ...
  public void dispatch(PluginUIListener l) {
    switch (id) {
      case PLUGIN_UI_SHOWN:
        l.pluginUIShown(this);
        break;
      case PLUGIN_UI_HIDDEN:
        l.pluginUIHidden(this);
        break;
      case PLUGIN_UI_CLOSING:
        l.pluginUIClosing(this);
        break;
      case PLUGIN_UI_ACTIVATED:
        l.pluginUIActivated(this);
        break;
      case PLUGIN_UI_DEACTIVATED:
        l.pluginUIDeactivated(this);
        break;
      case PLUGIN_UI_DISPOSED:
        l.pluginUIDisposed(this);
        break;
      case PLUGIN_UI_TITLE_CHANGED:
        l.pluginUITitleChanged(this);
        break;
      case PLUGIN_UI_ICON_CHANGED:
        l.pluginUIIconChanged(this);
        break;
    }
  }
}
