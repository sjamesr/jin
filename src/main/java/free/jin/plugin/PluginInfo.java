...
/**
 * Holds information about a plugin which is available without actually instantiating the plugin.
 */
public class PluginInfo {
  ...
  /**
   * Creates a new <code>PluginInfo</code> object with the specified plugin class and preferences.
   */
