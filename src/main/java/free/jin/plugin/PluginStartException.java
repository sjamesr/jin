...
public class PluginStartException extends Exception {
  ...
  /**
   * Creates a new <code>PluginStartException</code> with the specified cause exception.
   */
  ...
  /**
   * Creates a new PluginStartException with the specified error message and no cause exception.
   */
  ...
  /**
   * Creates a new <code>PluginStartException</code> with the specified cause exception and error
   * message.
   */
