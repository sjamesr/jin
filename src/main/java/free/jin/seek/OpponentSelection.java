...
public final class OpponentSelection {
  ...
  /**
   * Creates a new <code>OpponentSelection</code> with the specified list of opponents for easy
   * selection and an initial value.
   */
  ...
  /**
   * Adds the specified change listener to receive notifications when the selected opponent changes.
   */
  ...
  /**
   * Removes the specified change listener from receiving notifications when the selected opponent
   * changes.
   */
