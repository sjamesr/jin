...
public class MatchOffer extends Struct {
   ...
   * @param isChallengerProvisional Whether the challenger's rating is provisional.
  ...
  public MatchOffer(
      ...
      Player challengerColor) {

    if (challenger == null) throw new IllegalArgumentException("challenger may not be null");
    if (receiver == null) throw new IllegalArgumentException("receiver may not be null");
