...
/**
 * An encapsulation of the properties that any game list item has. The superclass of all specific
 * game list items. Instances of this class are immutable, and so should instances of its subclasses
 * be.
 */
public abstract class GameListItem {

  /**
   * All of the game properties are kept in this Hashtable. There are just too many of them to be
   * confortably kept in instance variables :-)
   */
   ...
   * @param ratingCategoryString The name of the category to which the game belongs.
  ...
  protected final void setProperty(Object property, Object propertyValue) {
    ...
    if (oldValue != null) {
      ...
      throw new IllegalArgumentException(
          "A property's value may not be reset - attempted to reset the value of " + property);
    }
  }
  ...
  /**
   * Returns the date of the game. What this date exactly means (start, end or whatever other
   * relevant point in time) depends on the subclass.
   */
  ...
  /**
   * Returns the time of the game. What this date exactly means (start, end or whatever other
   * relevant point in time) depends on the subclass.
   */
  ...
  /**
   * Returns the number of milliseconds by which the clock of the white player is incremented each
   * time he makes a move. This could be used to indicate increment in Bronstein-clock style,
   * depending on the clock style used by the server.
   */
  ...
  /**
   * Returns the number of milliseconds by which the clock of the black player is incremented each
   * time he makes a move. This could be used to indicate increment in Bronstein-clock style,
   * depending on the clock style used by the server.
   */
