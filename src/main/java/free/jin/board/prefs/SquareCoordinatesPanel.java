...
public class SquareCoordinatesPanel extends BoardModifyingPrefsPanel {
  ...
  /**
   * Creates a new SquareCoordinatesPanel for the specified BoardManager and with the specified
   * preview board.
   */
  ...
  private int getCoordsDisplayStyle() {
    ...
    else if (outside.isSelected()) return JBoard.OUTSIDE_COORDS;
    else if (everySquare.isSelected()) return JBoard.EVERY_SQUARE_COORDS;
