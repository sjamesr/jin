...
public abstract class BoardModifyingPrefsPanel extends PreferencesPanel {
  ...
  /**
   * Creates a new BoardModifyingPrefsPanel for the specified <code>BoardManager</code> and with the
   * specified preview board.
   */
  ...
  /**
   * Sets the initial properties of the preview board. This method is intended to be overriden by
   * subclasses to apply the initial properties of the board that the particular subclass is
   * responsible for.
   */
