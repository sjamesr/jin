 ...
 * pieces belong exlusively to chessclub.com - you may use them only as part of Jin and only with
 * the chessclub.com server. You may *not* use them for any other purpose, commercial or otherwise.
 */
public final class BlitzinVectorPiecePainter extends VectorPiecePainter {

  /**
   * Creates a new BlitzinVectorPiecePainter. White pieces will have the white color and black
   * pieces the black color.
   */
  ...
  /**
   * Creates a new BlitzinVectorPiecePainter which will produce White and black pieces with the
   * given colors. The outline of the pieces will have the opposite RGB values from the RGB values
   * of the given colors (if the color for the white pieces is for example R=255 G=128 B=0 then the
  ...
  /**
   * Creates a new BlitzinVectorPiecePainter which will produce white and black pieces with the
   * given colors and the given outline colors.
   *
   * @param whiteColor The color for the white pieces.
   * @param blackColor The color for the black pieces.
