...
public class FreechessBoardPanel extends BoardPanel {
  ...
  /**
   * Creates a new <code>FreechessBoardPanel</code> with the given <code>BoardManager</code> and
   * <code>Game</code>.
   */
  ...
  /** Overrides BoardPanel.createWhiteLabelText(Game) to return a freechess.org specific version. */
  @Override
  ...
  /** Overrides BoardPanel.createBlackLabelText(Game) to return a freechess.org specific version. */
  @Override
