...
public class FreechessBoardManager extends BoardManager implements IvarStateChangeListener {
  ...
  /**
   * Creates a new <code>FreechessBoardManager</code>. Registers a listener for the moveSendingMode
   * property to reflect its value in the premove ivar.
   */
  ...
  /**
   * Sets the initial value of autoflag to 1. This is really the server's job, but since FICS
   * refuses to do the reasonable thing, we must.
   */
  @Override
