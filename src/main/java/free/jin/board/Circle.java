...
public final class Circle {
  ...
  /**
   * Creates a new <code>Circle</code> at the specified square and with the specified color.
   */
  ...
  /**
   * Returns whether this circle is the same as the specified one. Two circles are the same if they
   * are at the same square and have the same color.
   */
  @Override
