...
/**
 * Encapsulates a Command issued by the user. A Command consists of the command string and boolean
 * flags specifying properties of the command. A Command can be blanked, in which case it won't be
 * echoed to the screen or saved anywhere. A command can also be special, in which case it will be
 * processed by special code which is familiar with the particular command string. A regular Command
