...
/**
 * An ICC (main server) channel. This class is needed not (only) for its functionality, but because
 * channel properties (such as name, description) are retrieved via an <code>I18n</code> object
