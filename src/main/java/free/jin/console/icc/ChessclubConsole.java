...
public class ChessclubConsole extends Console {
  ...
  /**
   * Creates a new <code>ChessclubConsole</code> with the specified designation, to be used with the
   * specified <code>ChessclubConsoleManager</code>.
   */
  ...
  /**
   * Creates the <code>ConsoleTextField</code> in which the user can input commands to be sent to
   * the server. Overrides <code>Console.createInputComponent()</code> since we need a special
   * <code>ConsoleTextField</code> for ICC.
   */
  @Override
  ...
  /**
   * Overrides <code>Console.createOutputComponent()</code> since we need a special <code>
   * ConsoleTextPane</code> for ICC.
   */
  @Override
  ...
  /**
   * Works around the issue with specially layed out finger noted, such as "finger Live" by
   * splitting lines with lots of spaces followed by a ':'. See
   * http://sourceforge.net/tracker/index.php?func=detail&aid=675197&group_id=50386&atid=459537 for
   * more information.
   */
  @Override
