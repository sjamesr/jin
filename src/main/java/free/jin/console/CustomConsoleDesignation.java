...
public abstract class CustomConsoleDesignation extends ChatConsoleDesignation{
  ...
  /**
   * A regular expression we match messages with, and display them if they
   * match.
   */
   ...
   * @param messageRegex A regular expression to match messages to and display
   * them if they match.
   */
  
  public CustomConsoleDesignation(Connection connection, String name, String encoding, boolean isConsoleCloseable,
