...
/**
 * An class encapsulating a link in a ConsoleTextPane. A Link consists of 2 integers specifying the
 * start and end of the link in the text and the
 */
public class Link {
  ...
  /**
   * Creates a new Link with the given starting and ending positions and the <code>Command</code> to
