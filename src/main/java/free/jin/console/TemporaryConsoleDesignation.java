...
/**
 * A console designation which, when added, issues a specified list of commands and displays their
 * output, without allowing further interaction with the user.
 *
...
public class TemporaryConsoleDesignation extends AbstractConsoleDesignation {
  ...
  /**
   * Creates a new <code>TemporaryConsoleDesignation</code> which, when added will issue the
   * specified list of commands.
   */
  public TemporaryConsoleDesignation(
      Connection connection, String name, String encoding, boolean isCloseable, String[] commands) {
