...
public class HistoryListItem extends GameListItem {
  ...
  /**
   * Creates a new HistoryListItem with the given GameListItem properties, given game end
   * explanation string, result status, and the player for whom the command was issued. Possible
