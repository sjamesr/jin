...
/**
 * Defines various username policies, such as which usernames are legal, whether they are case
 * sensitive etc.
 */
public interface UsernamePolicy {
  ...
  /**
   * Given a username, returns a string describing a reason why it is invalid, or <code>null</code>
