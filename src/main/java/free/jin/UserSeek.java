...
public class UserSeek extends Struct {
   ...
   * @param color The color the seeking player wants to play with or <code>null</code> if he has no
   *     preference.
   * @param minRating The minimum desired rating for the opponent. Use <code>Integer.MIN_VALUE
   *     </code> if you don't want to limit it.
   * @param maxRating The maximum desired rating for the opponent. Use <code>Integer.MAX_VALUE
   *     </code> if you don't want to limit it.
   * @param isManualAccept Whether the seeking player wishes to manually confirm that he wants to
   *     play against whoever accepts his seek.
   * @param isFormula Whether the seeking player wants accepting players to be filtered through his
   *     formula.
   */
  public UserSeek(
      int time,
      ...
      int minRating,
      int maxRating,
      boolean isManualAccept,
      boolean isFormula) {

    if (time < 0) throw new IllegalArgumentException("time may not be negative");
    if (inc < 0) throw new IllegalArgumentException("inc may not be negative");
    if (variant == null) throw new IllegalArgumentException("variant may not be null");
  ...
  /**
   * Returns the color the seeking player wishes to play with, or <code>null</code> if he has no
   * preference.
   */
  ...
  /**
   * Returns the minimum desired rating of the opponent, or <code>Integer.MIN_VALUE</code> if the
   * rating is not limited from below.
   */
  ...
  /**
   * Returns the maximum desired rating of the opponent, or <code>Integer.MAX_VALUE</code> if the
   * rating is not limited from above.
   */
  ...
  /**
   * Returns whether the seeking player wishes to manually confirm that he wants to play against
   * whoever accepts his seek.
   */
  ...
  /**
   * Returns whether the seeking player wants accepting players to be filtered through his formula.
   */
