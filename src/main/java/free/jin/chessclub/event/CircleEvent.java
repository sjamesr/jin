...
public class CircleEvent extends GameEvent {
  ...
  /**
   * The id of this event. Either {@link #CIRCLE_ADDED} or {@link #CIRCLE_REMOVED}.
   */
   ...
   * <code>Game</code>, id and the square of the circle.
   */
  public CircleEvent(
      JinChessclubConnection conn, String clientTag, Game game, int id, Square circleSquare) {
  ...
  /**
   * Returns the id of this event, either {@link #CIRCLE_ADDED} or {@link #CIRCLE_REMOVED}.
   */
  public int getId() {
    return id;
  }
