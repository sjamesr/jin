...
public class ChessEventEvent extends JinEvent {
  ...
  /**
   * Creates a new ChessEventEvent with the given originating JinChessclubConnection, id and
   * ChessEvent.
   */
  public ChessEventEvent(
      JinChessclubConnection conn, String clientTag, int id, ChessEvent chessEvent) {
    ...
    if (chessEvent == null) throw new IllegalArgumentException("chessEvent may not be null");
