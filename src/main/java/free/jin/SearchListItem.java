...
public class SearchListItem extends GameListItem {
  ...
  /**
   * Creates a new SearchListItem with the given GameListItem properties, given "game end
   * explanation string" and result status. Possible result status values are defined in <code>
   * JinConnection</code>.
   */
