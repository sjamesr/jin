...
public class LibListItem extends GameListItem {
  ...
  /**
   * Creates a new LibListItem with the given GameListItem properties, given
   * "game end explanation string", result status and note. Possible result status values are
   * defined in <code>JinConnection</code>.
   */
  public LibListItem(
      int index,
      String gameID,
