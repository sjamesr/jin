...
public interface MatchOfferConnection extends Connection {
  ...
  /**
   * Accepts the specified match offer. The match offer must an instance generated by this
   * <code>MatchOfferConnection</code> and must be current.
   */
  void accept(MatchOffer offer);

  /**
   * Declines the specified match offer. The match offer must an instance generated by this
   * <code>MatchOfferConnection</code> and must be current.
   */
