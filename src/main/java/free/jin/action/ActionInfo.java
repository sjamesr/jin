...
/** Encapsulates the information about a JinAction required for one to be created properly. */
public class ActionInfo {
  ...
  /**
   * Creates a new <code>ActionInfo</code> object with the specified class (implementing the action)
   * and preferences.
   */
