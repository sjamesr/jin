...
public class UpgradeDialog {
  ...
  private JDialog createDialog() {
    ...
    JLabel[] labels =
        SwingUtils.labelsForLines(i18n.getFormattedString("text", new Object[] {Jin.getAppName()}));
    ...
    visitWebsiteButton.addActionListener(
        new ActionListener() {
          @Override
    ...
    layout.setVerticalGroup(
        layout
            .createSequentialGroup()
            .add(layout.createParallelGroup(GroupLayout.CENTER).add(icon).add(vLabelsGroup))
