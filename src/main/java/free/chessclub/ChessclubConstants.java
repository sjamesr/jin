...
/** This inteface defines various magic constants used in the chessclub.com protocol. */
public interface ChessclubConstants {
  ...
  /** The code for a main line move, part of a DG_POSITION_BEGIN (either play or examine mode) */
  public static final int INITIAL_MOVE = 0;

  /** The code for a main line move, play mode. */
  public static final int PLAYED_MOVE = 1;

  /** The code for a main line move, examine mode. The result of "forward 1", for example. */
  ...
  /**
   * The code for a move in examine mode, intended to overwrite a previous line. (Not implemented
   * yet).
   */
  public static final int OVERWRITE_MOVE = 4;

  /**
   * The code for a move in examine mode, intended to be the new main line. (Not implemented yet).
   */
  public static final int MAINLINE_MOVE = 5;

  /** The code for a move in examine mode, intended to be a side line. (Not implemented yet). */
