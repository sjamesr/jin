...
public class DatagramEvent extends EventObject {
   ...
   * <code>ChessclubConnection</code>, the received <code>Datagram</code> and the client tag
   * (referred to as "arbitrary-word" in <code>formats.txt</code>) of the containing level1 packet,
   * if any.
   */
