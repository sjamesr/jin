 ...
 * that it can be created via <code>Class.newInstance</code> and initialized by invoking the <code>
 * load</code> method.
 */
public interface ResourcePiecePainter extends PiecePainter {

  /**
   * Loads this <code>ResourcePiecePainter</code> from the specified URL. This method should be
   * called immediately after creating the painter and may only be called once.
   */
