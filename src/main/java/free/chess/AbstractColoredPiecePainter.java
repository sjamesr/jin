...
public abstract class AbstractColoredPiecePainter implements ColoredPiecePainter {
  ...
  /**
   * Creates a new <code>AbstractColoredPiecePainter</code>. White pieces will be drawn with white
  ...
  /**
   * Creates a new <code>AbstractColoredPiecePainter</code> which will draw white and black pieces
   * using the given colors. The outline of the pieces will have an RGB value reverse to the RGB
   * values of the given colors (if the color for the white pieces is for example R=255 G=128 B=0
   * then the outline of the white pieces will be R=0 G=127 B=255).
   *
  ...
  /**
   * Creates a new <code>AbstractColoredPiecePainter</code> which will produce white and black
   * pieces with the given colors and the given outline colors.
   *
   * @param whiteColor The color for the white pieces.
   * @param blackColor The color for the black pieces.
  ...
  public AbstractColoredPiecePainter(
    ...
    if (whiteColor == null) throw new IllegalArgumentException("Null white color");
    if (blackColor == null) throw new IllegalArgumentException("Null black color");
    if (whiteOutline == null) throw new IllegalArgumentException("Null white outline color");
    if (blackOutline == null) throw new IllegalArgumentException("Null black outline color");
