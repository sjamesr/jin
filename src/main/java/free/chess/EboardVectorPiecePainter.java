...
/**
 * An implementation of PiecePainter which draws the vector pieces used in the "eboard" program.
 * This class is based on artwork created by Felipe Paulo Guazzi Bergo and licensed by him for use
 * here under the LGPL license. Here is his contact information: eboard - chess client
 * http://eboard.sourceforge.net Copyright (C) 2000-2001 Felipe Paulo Guazzi Bergo bergo@seul.org
 */
public final class EboardVectorPiecePainter extends VectorPiecePainter {

  /**
   * Creates a new EboardVectorPiecePainter. White pieces will have the white color and black pieces
   * the black color.
   */
  ...
  /**
   * Creates a new EboardVectorPiecePainter which will produce White and black pieces with the given
   * colors. The outline of the pieces will have the opposite RGB values from the RGB values of the
   * given colors (if the color for the white pieces is for example R=255 G=128 B=0 then the outline
   * of the white pieces will be R=0 G=127 B=255).
   *
  ...
  /**
   * Creates a new EboardVectorPiecePainter which will produce white and black pieces with the given
   * colors and the given outline colors.
   *
   * @param whiteColor The color for the white pieces.
   * @param blackColor The color for the black pieces.
