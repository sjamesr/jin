...
/**
 * Implements Fischer time control, where a fixed amount of time is added to a player's clock after
 * each move he makes.
 */
public final class FischerTimeControl extends TimeControl {
  ...
  /**
   * Creates a new <code>FischerTimeControl</code> with the specified initial time and increment.
   *
