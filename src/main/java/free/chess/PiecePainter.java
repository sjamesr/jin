...
public interface PiecePainter {
   ...
   * scaled to the given size. The <code>component</code> argument may be null. The
   * <code>shaded</code> argument specifies whether the piece should be drawn in a special, shaded
   * manner.
   */
