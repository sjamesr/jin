...
/**
 * The default PiecePainter implementation used in JBoard. This PiecePainter supports the pieces in
 * all wild variants defined in the free.chess package and all its subpackages. This class currently
 * uses <code>free.chess.EboardVectorPiecePainter</code> to paint the pieces, but this is an
 * implementation detail which you should not rely on. The artwork belongs solely to the author(s)
 * of eboard. For additional information see <A HREF="http://eboard.sourceforge.net/">the eboard
 * website</A>
 */
public class DefaultPiecePainter implements PiecePainter {
  ...
  /** Since <code>DefaultPiecePainter</code> is immutable, simply returns </code>this</code>. */
  @Override
