...
public interface BoardPainter {
  ...
  /**
   * Paints the board at the given location on the given Graphics scaled to the given size. The
   * <code>component</code> argument may be null.
   */
  void paintBoard(Graphics g, Component component, int x, int y, int width, int height);

  /**
   * Returns a new <code>BoardPainter</code> of the same class as this one. Implementations which
