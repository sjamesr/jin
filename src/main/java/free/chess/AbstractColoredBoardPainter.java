...
public abstract class AbstractColoredBoardPainter implements ColoredBoardPainter {
  ...
  /**
   * Creates a new <code>AbstractColoredBoardPainter</code> with the specified colors for light and
   * dark squares.
   */
  public AbstractColoredBoardPainter(Color lightColor, Color darkColor) {
    if (lightColor == null) throw new IllegalArgumentException("Null light color");
    if (darkColor == null) throw new IllegalArgumentException("Null dark color");
  ...
  /**
   * Creates a new <code>AbstractColoredBoardPainter</code> with default colors for light and dark
   * squares.
   */
