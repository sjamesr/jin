...
/**
 * Represents a "soldier" in the game of chess - a chess piece. This class does not allow to create
 * instances of itself, instead it defines constants that represent each chess piece. This means
 * that two Pieces are the same piece only if they reference the same object. An empty square is
 * represented by null.
 */
public class ChessPiece extends Piece {
  ...
  /**
   * Returns the ChessPiece corresponding to the given string. The string is expected to be in the
   * format returned by the {@link #toShortColorString()} method.
   */
  ...
  /**
   * Returns <code>true</code> if this chess piece is of the same type (rook, queen, etc.) as the
   * given piece.
   */
  ...
  /**
   * Returns a short (notational) string representing this chess piece ("N" for a white knight for
  ...
  public String toShortString() {
    if (isPawn()) return "P";
    else if (isKnight()) return "N";
    else if (isBishop()) return "B";
    else if (isRook()) return "R";
    else if (isQueen()) return "Q";
    else if (isKing()) return "K";
  ...
  public String getTypeName() {
    ...
    else if (isKnight()) return "Knight";
    else if (isBishop()) return "Bishop";
    else if (isRook()) return "Rook";
    else if (isQueen()) return "Queen";
    else if (isKing()) return "King";
