...
public class OddsTimeControl extends TimeControl{
  ...
  /**
   * Creates a new <code>OddsTimeControl</code> with the specified white and
   * black time controls. 
   */
  ...
  public boolean equals(Object o){
    ...
    return tc.whiteTimeControl.equals(whiteTimeControl) && tc.blackTimeControl.equals(blackTimeControl);
  }
