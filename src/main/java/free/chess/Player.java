...
/**
 * Defines two constants, one for the player with the white pieces and one for the player with the
 * black pieces.
 */
public class Player {
  ...
  /**
   * Returns the color of the pieces this player plays with - either {@link Piece#WHITE} or {@link
   * Piece#BLACK}.
   */
  ...
  public Player getOpponent() {
    if (this.isWhite()) return BLACK_PLAYER;
    else return WHITE_PLAYER;
  }

  /**
   * Returns "White" for the player with the white pieces and "Black" for the player with the black
   * pieces.
   */
  @Override
  public String toString() {
    if (this == WHITE_PLAYER) return "White";
    else return "Black";
  }
}
