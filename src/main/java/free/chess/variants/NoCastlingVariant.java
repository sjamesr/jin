...
/**
 * Implements a wild variant which differs from regular chess in that castling is not allowed. This
 * class extends {@link ChesslikeGenericVariant} without defining the initial position and name, so
 * this is still a generic variant.
 */
