...
/**
 * Implements the "Suicide" wild variant. The "Suicide" variant is just like "Giveaway" on ICC, but
 * castling is not allowed.
 */
public class Suicide extends NoCastlingVariant {

  /**
   * An array containing WHITE_QUEEN, WHITE_ROOK, WHITE_BISHOP, WHITE_KNIGHT, WHITE_PAWN and
   * WHITE_KING. These are the pieces to which a white pawn can be promoted to in Suicide.
   */
  ...
  /**
   * An array containing BLACK_QUEEN, BLACK_ROOK, BLACK_BISHOP, BLACK_KNIGHT, BLACK_PAWN and
   * BLACK_KING. These are the pieces to which a black pawn can be promoted to in Suicide.
   */
