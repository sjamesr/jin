...
public class Giveaway extends ChesslikeGenericVariant {
  ...
  /**
   * An array containing WHITE_QUEEN, WHITE_ROOK, WHITE_BISHOP, WHITE_KNIGHT and WHITE_KING. These
   * are the pieces to which a white pawn can be promoted to in Giveaway.
   */
  ...
  /**
   * An array containing BLACK_QUEEN, BLACK_ROOK, BLACK_BISHOP, BLACK_KNIGHT and BLACK_KING. These
   * are the pieces to which a black pawn can be promoted to in Giveaway.
   */
