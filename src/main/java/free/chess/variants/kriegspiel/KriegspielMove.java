 ...
 *
 * <UL>
 *   <LI>A partially hidden move, where only the target square is known because it was a capture of
 *       the player's piece.
...
public class KriegspielMove extends Move {
   ...
   * capture). The {@link #isCompletelyHidden()} method will return <code>true</code>. <code>
   * stringRepresentation</code> may be <code>null</code> in which case a string constructed from
   ...
   * #isCompletelyHidden()} method will return <code>false</code>. <code>stringRepresentation</code>
   * may be <code>null</code> in which case a string constructed from the move data will be returned
   * by toString()..
   */
  ...
  /** Always returns <code>null</code> since the starting square is always unknown. */
  @Override
  ...
  /**
   * Returns the square to which the moving piece moved or <code>null</code> if the move is
   * completely hidden.
   */
  @Override
  ...
  public String getMoveString() {
    ...
    else return "?x" + getEndingSquare().toString();
  }
}
