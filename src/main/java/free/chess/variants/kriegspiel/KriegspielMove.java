...
public class KriegspielMove extends Move {
   ...
   * capture). The {@link #isCompletelyHidden()} method will return <code>true</code>.
   * <code>stringRepresentation</code> may be <code>null</code> in which case a string constructed
   ...
   * {@link #isCompletelyHidden()} method will return <code>false</code>.
   * <code>stringRepresentation</code> may be <code>null</code> in which case a string constructed
   * from the move data will be returned by toString()..
   */
