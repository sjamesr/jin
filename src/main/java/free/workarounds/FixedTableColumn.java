...
public class FixedTableColumn extends TableColumn {
  ...
  /**
   * Creates a new FixedTableColumn using a default model index of 0, default width of 75, a null
  ...
  /**
   * Creates a new FixedTableColumn using a default width of 75, a null renderer and a null editor.
   */
  ...
  protected void fixBugs() {
    ...
    if (getHeaderRenderer() == null) setHeaderRenderer(createDefaultHeaderRenderer());
