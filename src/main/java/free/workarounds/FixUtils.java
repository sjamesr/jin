...
/** A class containing various utilities allowing to work around various bugs in Java. */
public class FixUtils {

  /**
   * The value of CHAR_UNDEFINED in this JRE. This is needed because its value changed between 1.1
   * and 1.2. See <A
   * HREF="http://developer.java.sun.com/developer/bugParade/bugs/4106162.html">http:
   * //developer.java.sun.com/developer/bugParade/bugs/4106162.html</A> for more information.
   */
  ...
  static void fakeCopy(JTextComponent tc) {
    ...
    if ((selection != null) && (selection.length() > 0)) clipboard = selection;
  }
