...
/**
 * A runnable which catches and prints all Throwables except ThreadDeath thrown within its run
 * method. This should be used by code invoking some user code to prevent the calling thread from
 * dying because some exception was thrown in the user code.
 */
public abstract class SafeRunnable implements Runnable {

  /**
   * Wraps a call to safeRun() within a try..catch block which catches and prints all
   * RuntimeExceptions and Errors (except ThreadDeath) to the standard error stream.
   */
  @Override
