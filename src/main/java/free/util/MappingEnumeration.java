 ...
 * <code>Enumeration</code>, but modifies the values via the {@link #map(Object)} method, which can
 * be overridden to specify different mappings.
 */
public abstract class MappingEnumeration implements Enumeration {
  ...
  /**
   * Creates a new <code>MappingEnumeration</code> object with the specified delegate.
   */
  ...
  /**
   * Returns the result of invoking {@link #map(Object)} on the next element in the delegate
   * enumeration.
   */
  @Override
