...
public class FontSelectorPanel extends JPanel {
  ...
  /**
   * Creates a new <code>FontSelectorPanel</code> which will allow choosing from the list of fonts
   * available to the default Toolkit.
   */
  public FontSelectorPanel() {
    this(new BooleanFontOption[] {createBoldFontOption(), createItalicFontOption()});
  }

  /**
   * Creates a new </code>FontSelectorPanel</code> which will allow choosing from the list of fonts
   * available to the default Toolkit and will allow the user to select from the specified
   * BooleanFontOptions.
   */
  ...
  /**
   * Creates a new </code>FontSelectorPanel</code> which will allow choosing from the list of fonts
   * available to the default Toolkit at the specified sizes.
   */
  public FontSelectorPanel(int[] fontSizes) {
    this(fontSizes, new BooleanFontOption[] {createBoldFontOption(), createItalicFontOption()});
  }

  /**
   * Creates a new </code>FontSelectorPanel</code> which will allow choosing from the list of fonts
   * available to the default Toolkit at the specified sizes and will allow the user to select from
   * the specified BooleanFontOptions.
   */
  ...
  /**
   * Creates a new </code>FontSelectorPanel</code> which will allow choosing from the specified list
   * of fonts.
   */
  ...
  /**
   * Creates a new <code>FontSelectorPanel</code> which will allow choosing from the specified list
   * of fonts at specified sizes.
   */
  public FontSelectorPanel(String[] fontNames, int[] fontSizes) {
    this(
        fontNames,
        fontSizes,
        new BooleanFontOption[] {createBoldFontOption(), createItalicFontOption()});
  }

  /**
   * Creates a new <code>FontSelectorPanel</code> which will allow choosing from the specified list
   * of fonts with specified options.
   */
  ...
  /**
   * Creates a new FontSelectorPanel which will allow choosing from the specified list of fonts at
   * specified sizes with specified options.
   */
  public FontSelectorPanel(String[] fontNames, int[] fontSizes, BooleanFontOption[] fontOptions) {
    ...
    for (int i = 0; i < fontSizes.length; i++) fontSizesInts[i] = new Integer(fontSizes[i]);
  ...
  /**
   * Returns the <code>BooleanFontOption</code> with the specified id, or <code>null</code> if no
   * such <code>BooleanFontOption</code> exists.
   */
  ...
  public boolean getFontOptionValue(String optionId) {
    ...
    if (fontOption == null) throw new IllegalArgumentException();
    return fontOption.getValue();
  }

  /**
   * Creates a <code>BooleanFontOption</code> for specifying the whether the font is bold or not.
   */
  ...
  /**
   * Creates a <code>BooleanFontOption</code> for specifying the whether the font is italic or not.
   */
  ...
  public Font getSelectedFont() {
    ...
    if ((fontName == null) || (fontSize == null)) return null;

    int style = 0;
    BooleanFontOption boldOption = getFontOption(BOLD_OPTION_ID);
    BooleanFontOption italicOption = getFontOption(ITALIC_OPTION_ID);
    if ((boldOption != null) && boldOption.getValue()) style |= Font.BOLD;
    if ((italicOption != null) && italicOption.getValue()) style |= Font.ITALIC;
  ...
  public void setSelectedFont(Font font) {
    ...
    if (boldOption != null) boldOption.setValue(font.isBold());
    if (italicOption != null) italicOption.setValue(font.isItalic());
  ...
  /**
   * Adds a ChangeListener to the list of listeners receiving notifications when the selected font
   * changes.
   */
  ...
  public static class BooleanFontOption {
    ...
    /**
     * The index of the character that should be used for the mnemonic of the checkbox displaying
     * the choice for this option.
     */
    ...
    /**
     * Sets the current value of the option and notifies the user <code>FontSelectorPanel</code>.
     */
