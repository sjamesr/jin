...
/**
 * An extension of <code>javax.swing.table.DefaultTableModel</code> none of whose cells is editable.
 */
public class NonEditableTableModel extends DefaultTableModel {
  ...
  /**
   * Constructs a NonEditableTableModel with <code>numRows</code> and <code>numColumns</code> of
  ...
  /**
   * Constructs a NonEditableTableModel and initializes the table by passing <code>data</code> and
   * <code>columnNames</code> to the setDataVector() method. The first index in the Object[][] is
  ...
  /**
   * Constructs a NonEditableTableModel and initializes the table by passing <code>data</code> and
   * <code>columnNames</code> to the setDataVector() method.
   */
