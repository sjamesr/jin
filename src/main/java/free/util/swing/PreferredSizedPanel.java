...
public class PreferredSizedPanel extends JPanel {
  ...
  /**
   * Creates a new <code>PreferredSizedPanel</code> with the specified double buffering strategy.
   */
  ...
  /**
   * Creates a new <code>PreferredSizedPanel</code> with the specified layout manager and double
   * buffering strategy.
   */
  ...
  /**
   * Creates a <code>PreferredSizedPanel</code> which will hold the specified component. This allows
   * forcing any component to always be sized at its preferred size.
   */
