...
/**
 * The default <code>TabHandleFactory<code> implementation.
 */
public class DefaultTabHandleFactory implements TabHandleFactory {

  /**
   * The shared instance of this class.
   */
  private static final DefaultTabHandleFactory SHARED_INSTANCE = new DefaultTabHandleFactory();

  /**
   * Returns an instance of this class.
   */
  public static DefaultTabHandleFactory getInstance() {
