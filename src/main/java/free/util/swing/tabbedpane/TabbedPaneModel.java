...
public interface TabbedPaneModel {
  ...
  /** Returns the index of the specified tab; <code>-1</code> if no such tab exists in the model. */
  int indexOfTab(Tab tab);

  /**
   * Returns the index of the tab holding the specified component; <code>-1</code> if no such tab
   * exists in the model.
   */
  ...
  /**
   * Returns the index of the currently selected tab, or <code>-1</code> if there are no selected
   * tabs.
   */
  ...
  /** Selects the tab with the specified index. Use <code>-1</code> to deselect all tabs. */
