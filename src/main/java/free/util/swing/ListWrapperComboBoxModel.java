...
/**
 * A <code>ComboBoxModel</code> which wraps the specified<code>ListModel</code>
 * for its actual list, and manages the selected object in the most
 * straightforward way.
 */
...
public class ListWrapperComboBoxModel extends AbstractListModel implements ComboBoxModel{
  ...
  /**
   * Creates a new <code>ListWrapperComboBoxModel</code> which wraps the
   * specified <code>ListModel</code>.
   */
