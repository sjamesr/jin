...
/**
 * Implements decent switching between internal frames in a given desktop pane. The main
 * functionality of this class is tracking the order in which the frames are traversed. Note that
 * this class doesn't automaticall switch between the frames - you need to listen to the appropriate
 * events and call <code>selectNext</code> and <code>selectPrevious</code> yourself.
 */
