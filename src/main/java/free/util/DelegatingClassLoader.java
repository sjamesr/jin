...
public class DelegatingClassLoader extends ChildClassLoader {
  ...
  /**
   * The set of class/resource names we are currently in the process of loading. This is needed to
   * avoid endless recursion in case of delegate ChildClassLoaders that have this classloader as
   * their parent.
   */
