...
/**
 * An <code>ActionListener</code> and a <code>WindowListener</code> which disposes of the given
 * Window when one of <code>actionPerformed</code> or <code>windowClosing</code> methods are called.
 */
public class WindowDisposingListener implements ActionListener, WindowListener {
  ...
  /**
   * Creates a new <code>WindowDisposingListener</code> with the given target <code>Window</code>.
   */
  ...
  /**
   * This method is called just before the target <code>Window</code> is disposed. It is meant to be
   * overridden to allow subclasses run their own code when the window is being closed. The default
