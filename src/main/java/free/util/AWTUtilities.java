...
public class AWTUtilities {
   ...
   * while under JDK1.2 (via reflection),
   ...
   * if running under JDK 1.4 or later, otherwise returns 0. The call to
   * <code>Frame.getExtendedState()</code> is done via reflection to avoid runtime errors.
   */
   ...
   * running in JDK 1.4 or later, otherwise does nothing. The call to
   * <code>Frame.setExtendedState()</code> is done via reflection to avoid runtime errors.
   */
   ...
   *
   * This is a rather hacky method - it doesn't work well if there are both enabled and disabled
