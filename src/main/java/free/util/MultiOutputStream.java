...
/**
 * An <code>OutputStream</code> which relays all data written into it into a list of given
...
public class MultiOutputStream extends OutputStream {
  ...
  /**
   * Creates a new <code>MultiOutputStream</code> which relays data to the specified two
   * <code>OutputStreams</code>. Any <code>null</code> values will be silently ignored.
   */
  ...
  /**
   * Creates a new <code>MultiOutputStream</code> which relays data to the specified
   * <code>OutputStreams</code>. Any <code>null</code> items in the array will be silently ignored.
   */
