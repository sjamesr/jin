...
/**
 * An implementation of <code>URLStreamHandlerFactory</code> which maps protocol names to instances
 * of <code>URLStreamHandlerFactory</code> with a simple hashtable.
 */
public class MapURLStreamHandlerFactory implements URLStreamHandlerFactory {

  /**
   * A hashtable mapping protocol names to instances of <code>URLStreamHandler</code> which handle
   * that protocol.
   */
  ...
  /**
   * Sets the specified protocol to be handled by the specified <code>URLStreamHandler</code>. The
  ...
  /**
   * Returns the <code>URLStreamHandler</code> for the specified protocol by delegating to <code>
   * getHandler(String protocol)</code>.
   */
  @Override
