...
/**
 * A rectangle with coordinates represented by double values. No restrictions are enforced on the
 * different values. This class is not thread safe.
 */
public final class RectDouble {
  ...
  /**
   * Creates a </code>java.awt.Rectangle</code> object from this one by casting all the values to
   * ints.
   */
