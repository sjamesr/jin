...
public abstract class FilteringEnumeration implements Enumeration {
  ...
  /**
   * Finds the next element in the delegate enumeration which passes <code>accept</code> and puts it
   * in <code>next</code>.
   */
  ...
  /**
   * Returns the next element in the delegate enumeration which passes the <code>accept</code>
   * method.
   */
  @Override
