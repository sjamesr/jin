...
public class FormatException extends RuntimeException {
  ...
  /**
   * Creates a new <code>FormatException</code> with the specified "reason" <code>Throwable</code>
   * and message.
   */
  ...
  /**
   * Returns the actual throwable that resulted in this exception. For example, if an attempt to
   * parse a string as an integer occurred, this should be the NumberFormatException that was thrown
   * by <code>Integer.parseInt</code>.
   */
