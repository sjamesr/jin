...
/**
 * An alternative implementation of PipedOutputStream. Note that this is just a wrapper, the real
...
class PipedOutputStream extends OutputStream {
  ...
  /** Creates a new PipedOutputStream which writes data to the given PipedStreams object. */
  ...
  /**
   * Writes the given amount of bytes from the specified byte array starting at the given offset to
   * the sink.
   */
  @Override
