...
public class Utilities {
  ...
  public static final Comparator NAME_COMPARATOR =
      new Comparator() {
        ...
        /**
         * Compares the specified objects, according to {@link Comparator#compare(Object, Object)}'s
         * contract.
         */
        @Override
  ...
  /**
   * Returns <code>true</code> if the two specified objects are the same. Returns <code>false</code>
   * otherwise. To be considered the same, the two references must either both be null or invoking
   * <code>equals</code> on one of them with the other must return <code>true</code>.
   */
  ...
  /**
   * Returns <code>true</code> if the specified object is an element of the specified array. The
   * specified array may not be <code>null</code>. The specified object may be <code>null</code>, in
   * which case this method will return <code>true</code> iff one of the indices in the array is
   * empty (contains <code>null</code>).
   */
  ...
  public static int indexOf(Object[] array, Object item) {
    ...
    for (int i = 0; i < array.length; i++) if (areEqual(item, array[i])) return i;

    return -1;
  }

  /**
   * Returns the index of the first occurrance of specified integer in the specified array, or -1 if
   * the specified integer is not an element of the specified array.
   */
  ...
  /**
   * Converts the specified array into a string by appending all its elements separated by a
   * semicolon.
   */
  public static String arrayToString(Object[] arr) {
    ...
    if (arr.length > 0) buf.setLength(buf.length() - 2); // get rid of the extra "; "

    return buf.toString();
  }

  /**
   * Converts the specified <code>Hashtable</code> into a string by putting each key and value on a
  ...
  public static int max(int[] arr) {
    ...
    int n = arr[0];
    for (int i = 1; i < arr.length; i++) if (arr[i] > n) n = arr[i];
  ...
  /**
   * Returns the short name (excluding the package name) of the class with the specified fully
   * qualified name.
   */
