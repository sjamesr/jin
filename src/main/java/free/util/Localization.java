...
public class Localization {
  ...
  /**
   * Creates a new <code>Localization</code> backed up by the specified <code>Properties</code>
   * object for the specified class. The keys in the properties resource are prefixed by the class
   * name.
   */
  ...
  /**
   * Loads and returns a <code>Localization</code> object for the specified class and the
   * application's locale. See {@link #load(Class, Locale)} and {@link #setAppLocale(Locale)} for
   * more details.
   */
  ...
  /**
   * Loads and returns a <code>Localization</code> object for the specified class and locale. The
  ...
  private static Properties loadTranslationProperties(Class c, Locale locale) {
    ...
    if ((country != null) && !"".equals(country))
      props =
          loadProps(c, props, propsFilenamePrefix + "_" + language + "_" + country + ".properties");
    if ((variant != null) && !"".equals(variant))
      props =
          loadProps(
              c,
              props,
              propsFilenamePrefix + "_" + language + "_" + country + "_" + variant + ".properties");
   ...
   * The specified <code>Properties</code> object is used as the default delegate for the returned
   * one.
   */
    ...
    if (in != null) {
      ...
      try {
        ...
        throw new MissingResourceException(
            "IOException while loading " + resourceName, c.getName(), "");
      }
    }
   ...
   * inserting <code>args</code> into the appropriate locations into it. If <code>args</code> is
   * <code>null</code>, the translation is returned as-is.
   */
  ...
  /**
   * Returns a new <code>Localization</code> object backed up by the same resources as this one, but
   * for the specified class. This is useful if several classes (in the same package) share a
   * localization properties resource.
   */
