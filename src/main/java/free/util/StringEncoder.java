...
public class StringEncoder {
  ...
  /**
   * Encodes the given Rectangle into a String in the following format: "<x>;<y>;<width>;<height>"
   * where <value> is replaced with the appropriate value of the given Rectangle.
   *
  ...
  /**
   * Encodes the given RectDouble into a String in the following format: "<x>;<y>;<width>;<height>"
   * where <value> is replaced with the appropriate value of the given RectDouble.
   *
  ...
  /**
   * Encodes the given Dimension into a String in the following format: "<width>;<height>" where
   * <value> is replaced with the appropriate value of the given Dimension.
   *
  ...
  /**
   * Encodes the given Color into a String in RGB format where each component is encoded into 2
   * characters as a hexadecimal string.
   */
  ...
  public static String encodeIntList(int[] arr) {
    ...
    if (arr.length != 0) buf.setLength(buf.length() - 1);
