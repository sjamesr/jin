...
public class ZipURLStreamHandler extends URLStreamHandler {
   ...
   * The <code>URL</code> will have "zip" as the protocol name. To use the resulting
   * <code>URL</code>, an application must set a <code>URLStreamHandlerFactory</code> (via the
   * <code>URL</code> class) which will return a <code>ZipURLStreamHandler</code> for the "zip"
   ...
   * <code>ZipURLStreamHandler</code> for the protocol name given to this method. Returns
   * <code>null</code> if the specified protocol is unrecognized.
   */
