...
/**
 * An alternative implementation of PipedInputStream. Note that this is just a wrapper, the real
 * action happens in PipedStreams.
 */
class PipedInputStream extends InputStream {
  ...
  /**
   * Returns the amount of bytes it's possible to read from this PipedInputStream without blocking.
   */
  @Override
  ...
  /**
   * Reads up to length bytes of data from this input stream into an array of bytes. This method
   * blocks until some input is available. If the argument b is null, a NullPointerException is
   * thrown.
   */
  @Override
