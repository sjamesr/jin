...
/**
 * An implementation of the Enumeration interface which enumerates the items of an array. Note: This
...
public class ArrayEnumeration implements Enumeration {
  ...
  public Object nextElement() {
    ...
    if (!hasMoreElements()) arr = null; // Neither do we need this any more.
    return item;
  }
