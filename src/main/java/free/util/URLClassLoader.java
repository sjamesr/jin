...
public class URLClassLoader extends ChildClassLoader {
  ...
  /**
   * Creates a new <code>URLClassLoader</code> which loads classes and resources from the specified
   * URL and the specified parent <code>ChildClassLoader</code> to which loading is delegated if a
   * class or a resource can't be found.
   */
  public URLClassLoader(URL url, ChildClassLoader parent) {
    super(parent);

    if (url == null) throw new IllegalArgumentException("The specified URL may not be null");
