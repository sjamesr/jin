  ...
  private void createUI(){
    ...
    layout.setHorizontalGroup(layout.createParallelGroup()
      .add(layout.createSequentialGroup()
        ...
        .add(layout.createParallelGroup(GroupLayout.LEADING, false)
          ...
          .add(opponent.getBox(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Integer.MAX_VALUE)
          .add(variant.getBox(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Integer.MAX_VALUE)
          .add(pieceColor.getBox(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Integer.MAX_VALUE)
          .add(ratedness.getBox(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Integer.MAX_VALUE)
        )
      )
      .add(layout.createSequentialGroup()
    ...
    layout.setVerticalGroup(layout.createSequentialGroup()
      .add(layout.createParallelGroup(GroupLayout.BASELINE)
        .add(opponent.getLabel()).add(opponent.getBox())
      )
