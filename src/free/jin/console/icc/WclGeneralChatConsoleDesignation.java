...
/**
 * The "general chat" console for the WCL server. This displays the Lobby
 * channel (250).
 * 
...
public class WclGeneralChatConsoleDesignation extends IcsGeneralChatConsoleDesignation{
  ...
  public WclGeneralChatConsoleDesignation(Connection connection, String encoding, boolean isConsoleCloseable){
