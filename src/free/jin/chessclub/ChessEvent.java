...
public class ChessEvent{
   ...
   * @param isJoinInNewWindow Whether the join commands should be executed in a
   * new window/console.
   * @param watchCommands The commands to issue to watch the event or
   * <code>null</code> if you can't watch the event.
   * @param isWatchInNewWindow Whether the watch commands should be executed in a
   * new window/console.
   ...
   * @param isInfoInNewWindow Whether the info commands should be executed in a
   * new window/console.
  ...
  public ChessEvent(int id, String description, String [] joinCommands, boolean isJoinInNewWindow,
      String [] watchCommands, boolean isWatchInNewWindow, String [] infoCommands, boolean isInfoInNewWindow,
      String confirmText, boolean isOpenToGuests){
  ...
  /**
   * Returns whether the join commands should be executed in a new
   * window/console.
   */
  ...
  /**
   * Returns whether the watch commands should be executed in a new
   * window/console.
   */
   ...
   * information about the event, or <code>null</code> if no such information is available.
   */
  ...
  /**
   * Returns whether the info commands should be executed in a new
   * window/console.
   */
