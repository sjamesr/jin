...
import free.jin.ChessEventJinConnection;
import free.jin.ChessEvent;
...
public class ChessEventEvent extends JinEvent{
   ...
   * ChessEventJinConnection, id and ChessEvent.
   */

  public ChessEventEvent(ChessEventJinConnection conn, int id, ChessEvent chessEvent){
    super(conn);
