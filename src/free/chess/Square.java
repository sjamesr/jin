...
public class Square{
  ...
  /**
   * Returns an instance of Square representing the given coordinates. Valid
   * values lie in the range [0-7].
   * 
   * @param file The file index [0-7]
   * @param rank The rank index [0-7]
   * 
  ...
  /**
   * Same as {@link #getInstance(int, int)}, but instead of throwing an
   * exception for illegal values, simply returns <code>null</code>. 
   */
