...
public class AddRemoveButtons extends JComponent{
  ...
  private static final Icon DISABLED_ADD_ICON = new ImageIcon(IconImageFilters.getDisabled(ADD_IMAGE));
  ...
  private static final Icon DISABLED_REMOVE_ICON = new ImageIcon(IconImageFilters.getDisabled(REMOVE_IMAGE));
  ...
  /**
   * Creates a new <code>AddRemoveButtons</code> widget with the specified
   * action listeners which are invoked when the buttons are clicked.
   */
